...
$(function () {
    ...
    if (dt_selector.length) {
        var datatable = dt_selector.DataTable({
            ...
            buttons: [
                {
                    text: '<i class="bx bx-plus me-0 me-lg-2"></i><span class="d-none d-lg-inline-block">Add Timezone</span>',
                    className: "add-new btn btn-primary mx-3",
                    attr: {
                        "data-bs-toggle": "modal",
                        "data-bs-target": "#addTimezoneModal",
                    },
                },
            ],
            ...
            columns: [
                ...
                { data: 'name', name: 'name' },
                { data: 'utc_offset', name: 'utc_offset' },
