...
$(function () {
    ...
    // Delete Record
    $('.datatables-permissions tbody').on('click', '.deleteDesignation', function () {
        dt_permission = dt_permission.row($(this).parents("tr"));
        ...
        $.easyAjax({
            ...
            type: "DELETE",
            disableButton: true,
            buttonSelector: ".deletePermission",
    ...
    // add
    $(document).on("click", "#addPermissionSubmit", function () {
        $.easyAjax({
            container: "#addPermissionForm",
            type: "POST",
            disableButton: true,
    ...
    // update
    $("body").on("click", "#editPermissionSubmit", function (event) {
        $.easyAjax({
            container: "#editPermissionForm",
            type: "PATCH",
            disableButton: true,
