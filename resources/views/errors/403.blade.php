...
@section('content')
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h1 class="mb-2 mx-2">Forbidden!</h1>
            <p class="mb-4 mx-2">{{ __($exception->getMessage() ?: 'Forbidden') }}</p>
            <a href="{{ url('/') }}" class="btn btn-primary">Back to home</a>
            <div class="mt-5">
                <img src="{{ asset('assets/img/illustrations/girl-hacking-site-' . $configData['style'] . '.png') }}"
