...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/modules/account-settings/security.js') }}"></script>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            @include('contents.account-settings.navs')
            <!-- Change Password -->
            <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-md-6 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge inp-group">
                                    <input class="form-control" type="password" name="current_password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-label="Current Password" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-1">
                                <button type="button" class="btn btn-primary me-2" id="changePassword">Save changes</button>
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 order-md-1 order-0">
                        <div class="text-center mt-md-n5 pt-md-2 mx-3 mx-md-0">
                            <img src="{{ asset('assets/img/illustrations/boy-working-' . $configData['style'] . '.png') }}"
